...
define([
    ...
    './httpRequest',
    './storage'
], function(httpFactory, httpRequest,Storage) {
    function isWxEnable() {
    ...
    */
    ...
    function initShareUrl(params) {
        ...
        if (!params) {
          wxShareConfig.shareLink = 'https://m.yml360.com/wechat/promotion/#/';
          return;
        }
        const yml_promoter_info = Storage.get("yml_promoter_info");
        const promoter_id =  yml_promoter_info ? yml_promoter_info.promoter_id : '';
        const promoter_name = yml_promoter_info ? yml_promoter_info.nickname : '';
        if (yml_promoter_info) {
          wxShareConfig.shareLink = 'https://m.yml360.com/wechat/promotion/#/register?promoter_id=' + promoter_id + "&promoter_name=" + promoter_name;
        } else {
          wxShareConfig.shareLink = 'https://m.yml360.com/wechat/promotion/#/register';
        }
    ...
    function init(params) {
        ...
        // }else{
        wxShareConfig = {
            shareTitle: '医美莱，一个能让你变美的APP',
            shareContent: '注册医美莱，开启美丽人生！',
            shareImgUrls: httpRequest.getBaseWebappUrl().replace(/\/client/,'') + 'wechat/client/static/img/share.png',//size为120X120
            shareLink: '',
            isWxEnable: false,
            iswxConfigInit:false
    ...
    return {
        ...
        wxShareAll: wxShareAll,
        init: init,
        getWxShareConfig: getWxShareConfig,
