...
export default function wxLogin() {
  ...
  //   console.log(re);
  // })
  const url = encodeURIComponent('https://preview.yml360.com/wechat/promotion/#/loginReturn')
  location.href="https://preview.yml360.com/promote/?ct=wechat&ac=redirectToAuth&url="+url;
}
